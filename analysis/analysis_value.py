...
# print(f"HDS gets a profit of {sum_profit/20} max: {max_profit} min: {min_profit}")
...
print(f"HRS0 cost is {sum_cost_HRS0/20} max: {max_cost_HRS0} min: {min_cost_HRS0}")
print(f"HRS1 cost is {sum_cost_HRS1/20} max: {max_cost_HRS1} min: {min_cost_HRS1}")
...
print(f"Green CO2_central: {sum_G_CO2/200} max: {max_G_CO2} min: {min_G_CO2}")
print(f"Green CO2_dist: {sum_G_CO2_dist/100} max: {max_G_CO2_dist} min: {min_G_CO2_dist}")
print(f"Blue CO2: {sum_B_CO2/200} max: {max_B_CO2} min: {min_B_CO2}")
print(f"Gray CO2: {sum_X_CO2/200} max: {max_X_CO2} min: {min_X_CO2}")
...
# print(f"----------------------------------------H2 purchase------------------------------------------")
# print(f"Green H2 purchase for HRS0 is {sum_G_HRS0/20} max: {max_G_HRS0} min: {min_G_HRS0}")
# print(f"Green H2 purchase for HRS1 is {sum_G_HRS1/20} max: {max_G_HRS1} min: {min_G_HRS1}")
# print(f"On-site H2 HRS0 is {sum_OS_HRS0/20} max: {max_OS_HRS0} min: {min_OS_HRS0}")
# print(f"Blue H2 purchase for HRS0 is {sum_B_HRS0/20} max: {max_B_HRS0} min: {min_B_HRS0}")
# print(f"Blue H2 purchase for HRS1 is {sum_B_HRS1/20} max: {max_B_HRS1} min: {min_B_HRS1}")
# print(f"Gray H2 purchase for HRS0 is {sum_X_HRS0/20} max: {max_X_HRS0} min: {min_X_HRS0}")
# print(f"Gray H2 purchase for HRS1 is {sum_X_HRS1/20} max: {max_X_HRS1} min: {min_X_HRS1}")
