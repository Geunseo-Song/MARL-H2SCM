...
# plt.bar(time, bbb_0, color='g', label='Purchase_Green')
# plt.bar(time, ccc_0, color='r', label='Purchase_GRAY')
# plt.bar(time, ddd_0, color='b', label='Purchase_BLUE')
...
# plt.bar(time, ccc_1, color='r', label='Purchase_GRAY')
# plt.bar(time, ddd_1, color='b', label='Purchase_BLUE')
